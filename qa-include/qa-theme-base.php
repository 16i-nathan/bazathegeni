...
class qa_html_theme_base
{
	...
	{
		$attribution = '<!-- Made by Geni_Us Rwanda Group - http://www.geniusrwanda.org/ -->';
	...
	public function head_links()
	{
		if (isset($this->content['canonical'])) {
			...
			$this->output('<link href="favicon.ico" rel="shortcut icon" type="image/x-icon" />');
	...
	public function attribution()
	{
		...
		$this->output(
			...
			'Designed & Made by <a href="http://www.geniusrwanda.org">Geni_Us Rwanda Group</a>',
			'</div>'
		);
	}
